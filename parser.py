...
def get_exact_fuel_data():
    ...
    # Абсолютно точные координаты заездов на АЗС по спутниковым картам
    real_stations = [
        # --- БЕРЁЗОВСКИЙ ---
        # Газпромнефть 148 (ул. Трактовая, 11 — прямо у дороги на въезде в город)
        {"brand": "Газпромнефть", "number": "148", "lat": 56.911460, "lng": 60.776650, "address": "ул. Трактовая, 11"},
        
        # Флагман 3 (Березовский тракт, 9 — у авторазбора/выезда на ЕКАД)
        {"brand": "Флагман", "number": "3", "lat": 56.896740, "lng": 60.778520, "address": "Березовский тракт, 9"},
        
        # Лукойл 154 (ул. Максима Горького, 26 — у выезда в сторону Ново-Свердловской ТЭЦ)
        {"brand": "Лукойл", "number": "154", "lat": 56.907954, "lng": 60.814231, "address": "ул. Максима Горького, 26"},
        
        # Газпромнефть 149 (Режевской тракт, 15-й км — возле развязки и моста ближе к ЕКАД)
        {"brand": "Газпромнефть", "number": "149", "lat": 56.924240, "lng": 60.803730, "address": "Режевской тракт, 15-й км"},
